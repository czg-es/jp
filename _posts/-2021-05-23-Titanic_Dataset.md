...
sns.heatmap(datanew.isnull(),yticklabels=False,cbar=False,cmap='viridis') 
plt.show()
```


    
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_16_0.png)
...
![image.png](/jp/assets/img/TITANIC_DATASET/function_overview_8_0.png)
...
```python
plt.figure(figsize=(15,5))
sns.barplot(x = 'Sex', y = 'Survived', data = datanew, estimator= np.std)
```
...
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_20_1.png)
...
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_22_1.png)
...
```
    ...
    <matplotlib.legend.Legend at 0x214389d5460>




    
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_24_1.png)
...
```
    ...
    <matplotlib.legend.Legend at 0x214388a50d0>




    
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_26_1.png)
...
```
    ...
    <matplotlib.legend.Legend at 0x21438939df0>




    
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_28_1.png)
...
```python
plt.figure(figsize=(15,5))
sns.violinplot(x = 'Pclass', y = 'Survived', data = datanew[0:100] ,hue ='Embarked', palette='Wistia')
sns.swarmplot(x = 'Pclass', y = 'Survived', data = datanew[0:100],hue ='Embarked', color="red")
plt.legend(loc=0)
```
    ...
    <matplotlib.legend.Legend at 0x21438a2cdc0>




    
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_30_1.png)
...
```
    ...
    <matplotlib.legend.Legend at 0x21438ac4790>




    
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_32_1.png)
...
```python
plt.figure(figsize=(15,5))
sns.histplot(x = 'Sex', y = 'Age', data = datanew,hue ='Survived' )
...
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_35_1.png)
...
The approach is explained further in the [user guide](https://seaborn.pydata.org/tutorial/distributions.html#tutorial-kde "Seaborn docs. ").<br>
...
sns.kdeplot(x = 'Age', y = 'Pclass', data = datanew,hue ='Survived' )
```
...
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_37_1.png)
...
```python
plt.figure(figsize=(8,8))
sns.ecdfplot(x = 'Age', data = datanew, hue='Sex'  )
# sns.ecdfplot(data=datanew.filter(like=("Age"), axis="columns"))
```
...
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_39_1.png)
...
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_41_1.png)
...
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_44_1.png)
...
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_46_1.png)
...
sns.pairplot(datanew, hue ="Survived", palette="pastel")
plt.show()
```
...
![png](/jp/assets/img/TITANIC_DATASET/TITANIC_DATASET_v3-Copy1_48_1.png)
